...
# Form implementation generated from reading ui file 'c_alight.ui'
#
...
class Ui_modify_L(object):
    def setupUi(self, modify_L):
        ...
        self.card_id = QtWidgets.QLabel(modify_L)
        self.card_id.setGeometry(QtCore.QRect(40, 40, 111, 16))
        ...
        self.start_station.setGeometry(QtCore.QRect(40, 100, 111, 16))
        self.start_station.setObjectName("start_station")
        self.end_station = QtWidgets.QLabel(modify_L)
        self.end_station.setGeometry(QtCore.QRect(40, 160, 111, 16))
    ...
    def retranslateUi(self, modify_L):
        ...
        self.card_id.setText(_translate("modify_L", "card id:"))
