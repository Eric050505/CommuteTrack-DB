...
# Form implementation generated from reading ui file 'read_stations.ui'
#
...
class Ui_modify_L(object):
    def setupUi(self, modify_L):
        ...
        self.line_id = QtWidgets.QLabel(modify_L)
        self.line_id.setGeometry(QtCore.QRect(40, 40, 111, 16))
    ...
    def retranslateUi(self, modify_L):
        ...
        self.line_id.setText(_translate("modify_L", "station id:"))
