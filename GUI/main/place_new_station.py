...
# Form implementation generated from reading ui file 'place_new_station.ui'
#
...
class Ui_modify_L(object):
    def setupUi(self, modify_L):
        ...
        self.id.setGeometry(QtCore.QRect(40, 40, 111, 16))
        ...
        self.station.setGeometry(QtCore.QRect(40, 100, 150, 16))
        self.station.setObjectName("station")

        self.num_input = QtWidgets.QLineEdit(modify_L)
        self.num_input.setGeometry(QtCore.QRect(190, 160, 291, 20))
        self.num_input.setText("")
        self.num_input.setObjectName("num_input")
        self.num = QtWidgets.QLabel(modify_L)
        self.num.setGeometry(QtCore.QRect(40, 160, 150, 16))
    ...
    def retranslateUi(self, modify_L):
        ...
        self.num.setText(_translate("modify_L","num:"))
